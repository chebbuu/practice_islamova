...
<div class="container-fluid d-flex align-items-center justify-content-center">
    <div class="m-3 container p-4 d-flex gap-5"
         style="min-height: 85vh; background-color: white;box-shadow: 0px 2px 10px rgba(0,0,0,0.09); border-radius: 3px; ">
        <div class="w-75">
            <div class="d-flex" style="gap:20px;">
                <h3>Task</h3>
                <form action="{{route('search')}}" method="post" style="display: flex; gap: 15px; width: 75%" >
                    @csrf
                    @method('post')
                    <input class="form-control" name="search" style="width: 200%">
                    <x-button-main>{{('Find')}}</x-button-main>
                    <a href="/" style="text-decoration: none">  Все записи</a>
                </form>
            </div>
            ...
            <div class="">
                                ...
                                <div class="p-3" style="border: #dcdcdf 1px solid; border-radius:4px;">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="decoraten_b">
                                            <form method="post" action={{route('task.updateStatus',$task)}}>
                                                @csrf
                                                @method('PUT')
                                                <select name="status" onchange="this.form.submit()" class="form-select">
                                                    <option value="in process" {{$task->status == 'in_process' ? 'selected': ''}}>In process</option>
                                            ...
                                            <div class="modalbutton" style="position: relative">
                                                ...
                                                <div class="modalwindow p-4 "
                                                     style="z-index: 1000;position: absolute; background-color: white;box-shadow: 0px 2px 10px rgba(0,0,0,0.09); border-radius: 3px ">
                                                    <form style="width: 250px" class="d-flex flex-column gap-2"
                                                        ...
                                                        <button style="width: 100%;background-color: var(--main);border: 1px solid var(--main);border-radius: 3px;padding: 8px 3px ;color: white;">
                                                            Update
                                                        </button>
                                                    </form>
                                                </div>
                                    ...
                                    <p class="mt-2"
                                       style="overflow-wrap:break-word;word-break: break-all">{{$task['description']}}</p>
                                </div>
                            @endforeach
                        </div>
                ...
                @else
                    <div class="d-flex gap-2">
                        ...
                        <a href="/register"
                           style="color: #4f5259;font-weight: bold;text-decoration: none;">Registration</a>
                    </div>
                @endif
            </div>
        </div>
                    ...
                    <div class="">
                        ...
                        <div style="position:relative ">
                            <textarea type="text" name="description" id="description" class="form-control mb-2"
                                      maxlength="255" style="height: 300px; resize: none"></textarea>
